export function maskUrl (box: HTMLElement, innerBox: HTMLElement) {
  ...
  let url = `data:image/svg+xml;charset=utf8,<svg xmlns='http://www.w3.org/2000/svg' width='${boxSize.width}' height='${boxSize.height}'><mask id='mask'><rect x='0' y='0' width='${boxSize.width}' height='${boxSize.height}' fill='white'></rect>`
  ...
  url += `</mask><rect x='0' y='0' width='${boxSize.width}' height='${boxSize.height}' mask='url(%23mask)'></rect></svg>`
